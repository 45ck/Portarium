...
- Added implementation notes in:
  - `docs/adr/0032-event-stream-cloudevents.md` (references `bead-0316`, `bead-0340`)
  - `docs/adr/0070-hybrid-orchestration-choreography-architecture.md` (references `bead-0319`, `bead-0340`, `bead-0425`)
