...
- Implementation and review:
  - `docs/review/bead-0084-payments-billing-port-adapter-foundation.md`
- Code review:
  - `docs/review/bead-0085-code-review-payments-billing-foundation.md`
- Core surfaces:
...
- Low: payment method payloads remain intentionally represented as `ExternalObjectRef` rather than canonical provider-specific schemas, as already documented in `docs/review/bead-0085-code-review-payments-billing-foundation.md`.
