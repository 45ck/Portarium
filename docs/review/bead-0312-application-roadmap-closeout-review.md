...
- Roadmap coverage scan (`rg`) over `docs/application-layer-work-backlog.md`:
...
- Low: roadmap cross-reference status table in `docs/application-layer-work-backlog.md` contains stale status values for some beads; does not block roadmap scope acceptance.
