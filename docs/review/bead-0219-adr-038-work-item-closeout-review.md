...
- ADR-038 implementation and review:
  - `docs/review/bead-0053-adr-038-implementation.md`
  - `docs/review/bead-0054-adr-038-review.md`
- ADR-038 code review:
  - `docs/review/bead-0075-code-review-adr-038.md`
- Core surfaces:
...
- Low: dedicated server-handler contract coverage for multi-filter combinations (`runId` + `workflowId` + `approvalId` + `evidenceId`) remains a follow-up gap, already documented in `docs/review/bead-0075-code-review-adr-038.md`.
