...
- One remaining `vaop` token is in a research-programme filename reference (`docs/research/vaop-mvp-domain-atlas-research-programme.md`) and is treated as legacy artifact naming, not product-facing interface metadata.
