...
- Integration implementation and review:
  ...
  - `docs/review/bead-0087-review-payments-billing-test-evidence.md`
- Core test surfaces:
...
- Low: validation still covers deterministic in-memory behavior; provider API fixtures and live-provider conformance remain follow-up, as already documented in `docs/review/bead-0087-review-payments-billing-test-evidence.md`.
