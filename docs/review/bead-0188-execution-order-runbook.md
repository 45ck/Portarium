...
- `npx prettier --check docs/governance/execution-order-runbook.md docs/governance-work-backlog.md docs/index.md docs/review/bead-0188-execution-order-runbook.md`
- `npx cspell --no-progress --config cspell.json docs/governance/execution-order-runbook.md docs/governance-work-backlog.md docs/index.md docs/review/bead-0188-execution-order-runbook.md`
