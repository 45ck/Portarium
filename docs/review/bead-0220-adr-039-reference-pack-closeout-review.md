...
- ADR-039 implementation and review:
  - `docs/review/bead-0055-adr-039-implementation.md`
  - `docs/review/bead-0056-adr-039-review.md`
- ADR-039 code review:
  - `docs/review/bead-0076-code-review-adr-039.md`
- Core surfaces:
...
- Low: end-to-end runtime enable/disable lifecycle coverage for this pack remains a follow-up gap, already documented in `docs/review/bead-0076-code-review-adr-039.md`.
