...
- Media: `docs/ui/cockpit/demo-machine/showcase/approvals-v2-approval-gate.gif`
- Metadata: `docs/ui/cockpit/demo-machine/showcase/approvals-v2-approval-gate.json`
- README embed: `README.md`
- Demo docs updates: `docs/ui/cockpit/demo-machine/README.md`
