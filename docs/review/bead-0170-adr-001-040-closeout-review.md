...
- ADR documents in scope:
  ...
  - `docs/adr/0027-plan-objects-and-diff-truthfulness.md`
  - `docs/adr/0028-evidence-lifecycle-retention-privacy.md`
  - `docs/adr/0029-evidence-integrity-tamper-evident.md`
  - `docs/adr/0030-quota-aware-execution.md`
  - `docs/adr/0031-sod-as-policy-primitives.md`
  - `docs/adr/0032-event-stream-cloudevents.md`
  - `docs/adr/0033-observability-opentelemetry.md`
  - `docs/adr/0034-untrusted-execution-containment.md`
  - `docs/adr/0035-domain-atlas-research-pipeline.md`
  - `docs/adr/0036-product-identity-portarium.md`
  - `docs/adr/0037-deployment-collaboration-model.md`
  - `docs/adr/0038-work-items-universal-binding-object.md`
  - `docs/adr/0039-software-change-management-reference-vertical.md`
  - `docs/adr/0040-versioned-vertical-packs.md`
