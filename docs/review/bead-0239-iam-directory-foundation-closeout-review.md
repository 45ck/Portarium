...
- Implementation and review:
  - `docs/review/bead-0112-iam-directory-port-adapter-foundation.md`
- Code review:
  - `docs/review/bead-0113-code-review-iam-directory-foundation.md`
- Core surfaces:
...
- Low: membership and role-assignment flows remain intentionally deterministic in-memory transitions; provider-side reconciliation semantics remain follow-up work as already documented in `docs/review/bead-0113-code-review-iam-directory-foundation.md`.
