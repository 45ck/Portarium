...
| **ExternalObjectRef** | _(primitive)_                             | Any SoR entity                                                    | `system`, `objectType`, `objectId`, `url?`, `displayLabel?`                                                                     | First-class deep link for entities that do not map to a canonical object. The escape hatch that keeps the canonical model minimal.                                               |
