...
1. Follow `docs/governance/openclaw-workspace-gateway-provisioning-runbook.md` to
   re-provision the workspace Gateway.
2. Re-run `npm run ci:pr` on the fixed candidate.
3. Verify all six release gate controls from `docs/governance/openclaw-release-gate.md`
   are green.
