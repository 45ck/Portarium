...
**Reference:** `docs/adr/0072-openclaw-gateway-multi-tenant-isolation.md`
...
**Reference:** `docs/governance/openclaw-tool-blast-radius-policy.md`
...
**Reference:** `docs/adr/ADR-0099-openclaw-gateway-token-browser-exposure-prevention.md`
...
**Reference:** `docs/governance/openclaw-rollback-runbook.md`
...
4. The rollback runbook at `docs/governance/openclaw-rollback-runbook.md` exists and
...
(Summary — full procedure in `docs/governance/openclaw-rollback-runbook.md`)
...
| ADR-0099                     | `docs/adr/ADR-0099-openclaw-gateway-token-browser-exposure-prevention.md` |
| Release gate doc (this file) | `docs/governance/openclaw-release-gate.md`                                |
