...
### B-1 · Workforce detail body did not update on card click *(Critical — H1)*
...
### B-2 · Queue card click did not update detail panel *(Critical — H1)*
...
### B-3 · Approvals row 2 "Unassigned" was plain text, not chip *(Major — H4)*
...
### B-4 · WORKFORCE_DATA had wrong member names/emails *(Major — H1)*
...
### V-1 · Queue detail member rows do not update *(Moderate — H1)*
...
### V-2 · "Toggle availability" uses raw checkbox, not a toggle switch *(Minor — H4)*
...
### V-3 · Inbox "Default filters" chip is indistinguishable from toggleable chips *(Moderate — H4, H6)*
...
### V-4 · Inbox layout shifts between personas create disorientation *(Minor — H4)*
...
### V-5 · Workforce detail has significant empty whitespace below 4 cards *(Minor — H8)*
...
### V-6 · Approvals row 4 is missing an Approval Rule chip *(Minor — H1)*
...
### V-7 · HumanTask assignee link in Inbox has no link affordance *(Minor — H6)*
