...
**Prior audit:** `docs/ui/cockpit/ux-audit-report.md`
...
- RD3 (Outcome preview below submit): Fixed. Outcome preview is now above the form__actions div (lines 1224-1227, then 1228). Fixed.
...
```css
.card--subtle { border-style: dashed; box-shadow: none; background: rgba(255,255,255,0.5); }
.card--hero { padding: 16px; box-shadow: 0 4px 0 rgba(27,27,27,0.22); border-width: 2px; }
```
