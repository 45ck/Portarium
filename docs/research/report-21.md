...
- any dynamic identifier insertion (field names, schema names) must be *strictly* validated/whitelisted because identifiers cannot be parameterised. fileciteturn71file0L1-L1
