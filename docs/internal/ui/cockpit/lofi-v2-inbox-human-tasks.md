...
- Primary artifact: `docs/internal/ui/cockpit/index.html` (Inbox filters + cards)
- Visual captures:
- `docs/internal/ui/cockpit/screenshots/heuristic-01-inbox-operator.png`
- `docs/internal/ui/cockpit/screenshots/heuristic-02-inbox-approver.png`
- `docs/internal/ui/cockpit/screenshots/heuristic-17-inbox-human-tasks-chip.png`
