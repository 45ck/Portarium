...
- `map-workbench-extension-slots-plan.md` defines the proposed generic map workbench and extension side-panel boundary.

## How To View

Option A (simplest):

- Open `docs/internal/ui/cockpit/index.html` in a browser.
...
For scripted clip specs and runbook, see `docs/internal/ui/cockpit/demo-machine/README.md`.
...
- Layout and copy are derived from `docs/internal/ui/ux-ideas.json` composition 201.
...
- Fixtures live at `docs/internal/ui/cockpit/fixtures/demo.json`.
- Mock route interception is implemented in `docs/internal/ui/cockpit/mock-api.js`.
- A thin frontend DAL lives in `docs/internal/ui/cockpit/api-client.js`.
- UI hydration and decision-flow updates live in `docs/internal/ui/cockpit/demo-bindings.js`.
...
- Guidelines: `docs/internal/ui/cockpit/assets-guidelines.md`
