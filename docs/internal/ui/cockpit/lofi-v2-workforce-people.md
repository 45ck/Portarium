...
- Primary artifact: `docs/internal/ui/cockpit/index.html` (Workforce views)
- Visual captures:
- `docs/internal/ui/cockpit/screenshots/heuristic-03-workforce-directory.png`
- `docs/internal/ui/cockpit/screenshots/heuristic-04-workforce-bob-detail.png`
- `docs/internal/ui/cockpit/screenshots/heuristic-05-workforce-carol-detail.png`
