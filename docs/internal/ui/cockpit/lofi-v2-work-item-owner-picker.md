...
- Primary artifact: `docs/internal/ui/cockpit/index.html` (Work Item detail/list assignment states)
- Visual captures:
- `docs/internal/ui/cockpit/screenshots/heuristic-08-work-items.png`
- `docs/internal/ui/cockpit/screenshots/heuristic-09-work-item-detail.png`
- `docs/internal/ui/cockpit/screenshots/heuristic-10-owner-picker-open.png`
