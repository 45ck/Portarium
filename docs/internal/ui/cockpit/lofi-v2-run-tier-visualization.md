...
- Primary artifact: `docs/internal/ui/cockpit/index.html` (Run detail timeline + step panel)
- Visual captures:
- `docs/internal/ui/cockpit/screenshots/heuristic-12-run-detail-timeline.png`
- `docs/internal/ui/cockpit/screenshots/run-detail-v3.png`
- `docs/internal/ui/cockpit/screenshots/run-detail-improved.png`
