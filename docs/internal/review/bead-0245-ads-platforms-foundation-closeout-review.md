...
- Implementation and review:
  - `docs/internal/review/bead-0124-ads-platforms-port-adapter-foundation.md`
- Code review:
  - `docs/internal/review/bead-0125-code-review-ads-platforms-foundation.md`
- Core surfaces:
...
- Low: ad creative, auction, and telemetry semantics remain deterministic in-memory approximations; provider-side parity remains follow-up integration work, as already documented in `docs/internal/review/bead-0125-code-review-ads-platforms-foundation.md`.
