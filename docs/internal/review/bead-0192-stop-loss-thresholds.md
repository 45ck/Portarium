...
- `npx prettier --check docs/internal/governance/stop-loss-thresholds.md docs/internal/governance/stop-loss-thresholds-status.md scripts/beads/evaluate-stop-loss-thresholds.mjs src/infrastructure/beads/evaluate-stop-loss-thresholds.test.ts docs/internal/governance/execution-order-runbook.md docs/internal/governance-work-backlog.md docs/index.md docs/internal/review/bead-0192-stop-loss-thresholds.md`
- `npx cspell --no-progress --config cspell.json docs/internal/governance/stop-loss-thresholds.md docs/internal/governance/stop-loss-thresholds-status.md scripts/beads/evaluate-stop-loss-thresholds.mjs src/infrastructure/beads/evaluate-stop-loss-thresholds.test.ts docs/internal/governance/execution-order-runbook.md docs/internal/governance-work-backlog.md docs/index.md docs/internal/review/bead-0192-stop-loss-thresholds.md`
