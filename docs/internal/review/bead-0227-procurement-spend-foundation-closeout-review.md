...
- Implementation and review:
  - `docs/internal/review/bead-0088-procurement-spend-port-adapter-foundation.md`
- Code review:
  - `docs/internal/review/bead-0089-code-review-procurement-spend-foundation.md`
- Core surfaces:
...
- Low: expense reports and RFQs remain intentionally represented as `ExternalObjectRef` stubs; provider-specific payload schemas remain follow-up work as already documented in `docs/internal/review/bead-0089-code-review-procurement-spend-foundation.md`.
