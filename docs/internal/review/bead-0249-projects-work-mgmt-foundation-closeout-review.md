...
- Implementation and review:
  - `docs/internal/review/bead-0132-projects-work-mgmt-port-adapter-foundation.md`
- Code review:
  - `docs/internal/review/bead-0133-code-review-projects-work-mgmt-foundation.md`
- Core surfaces:
