...
- Implementation and review:
  - `docs/internal/review/bead-0144-monitoring-incident-port-adapter-foundation.md`
- Code review:
  - `docs/internal/review/bead-0145-code-review-monitoring-incident-foundation.md`
- Core surfaces:
