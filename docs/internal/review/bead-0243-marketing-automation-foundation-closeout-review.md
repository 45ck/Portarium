...
- Implementation and review:
  - `docs/internal/review/bead-0120-marketing-automation-port-adapter-foundation.md`
- Code review:
  - `docs/internal/review/bead-0121-code-review-marketing-automation-foundation.md`
- Core surfaces:
