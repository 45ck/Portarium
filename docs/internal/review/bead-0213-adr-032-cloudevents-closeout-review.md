...
- ADR-032 code review:
  - `docs/internal/review/bead-0069-code-review-adr-032.md`
- ADR-032 boundary review:
  - `docs/internal/review/bead-0042-adr-032-review.md`
- Governance follow-up review:
  - `docs/internal/review/bead-0490-cloudevents-envelope-review.md`
- Core implementation:
