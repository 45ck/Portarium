...
- Integration implementation and review:
  - `docs/internal/review/bead-0082-finance-accounting-port-adapter-integration-tests.md`
  - `docs/internal/review/bead-0083-review-finance-accounting-test-evidence.md`
- Core test surfaces:
...
- Low: coverage is deterministic in-memory only; provider API contract fixtures and live-provider conformance remain follow-up work, as already documented in `docs/internal/review/bead-0083-review-finance-accounting-test-evidence.md`.
