...
- Implementation and review:
  - `docs/internal/review/bead-0128-comms-collaboration-port-adapter-foundation.md`
- Code review:
  - `docs/internal/review/bead-0129-code-review-comms-collaboration-foundation.md`
- Core surfaces:
