...
- Implementation and review:
  - `docs/internal/review/bead-0080-finance-accounting-port-adapter-foundation.md`
- Code review:
  - `docs/internal/review/bead-0081-code-review-finance-accounting-foundation.md`
- Core surfaces:
...
- Low: journal/report/reconciliation operations remain intentionally opaque stubs in the in-memory adapter; provider-specific schema handling remains follow-up work as already noted in `docs/internal/review/bead-0081-code-review-finance-accounting-foundation.md`.
