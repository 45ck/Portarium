...
- Implementation and review:
  - `docs/internal/review/bead-0059-operation-contract-stubs.md`
  - `docs/internal/review/bead-0060-operation-contract-stub-verification.md`
- Code review:
  - `docs/internal/review/bead-0078-code-review-operation-contract-stubs.md`
- Core surfaces:
...
- Low: generator behavior still depends on expected markdown table structure in source research docs; parser-shape guard hardening remains a follow-up gap already captured in `docs/internal/review/bead-0078-code-review-operation-contract-stubs.md`.
