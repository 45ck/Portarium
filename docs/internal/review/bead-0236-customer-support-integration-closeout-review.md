...
- Implementation and review:
  - `docs/internal/review/bead-0106-customer-support-port-adapter-integration.md`
- Code review:
  - `docs/internal/review/bead-0107-review-customer-support-port-adapter-test-evidence.md`
- Core surfaces:
