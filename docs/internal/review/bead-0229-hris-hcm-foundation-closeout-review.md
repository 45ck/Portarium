...
- Implementation and review:
  - `docs/internal/review/bead-0092-hris-hcm-port-adapter-foundation.md`
- Code review:
  - `docs/internal/review/bead-0093-code-review-hris-hcm-foundation.md`
- Core surfaces:
...
- Low: department/position/time-off and org-structure payloads remain intentionally represented as `ExternalObjectRef` outputs; provider schema fidelity remains follow-up work as already documented in `docs/internal/review/bead-0093-code-review-hris-hcm-foundation.md`.
