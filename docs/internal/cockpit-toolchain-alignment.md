...
- Storybook CLI availability depends on the `storybook` meta-package being resolvable from the workspace scripts context, not just the `@storybook/*` scoped packages.
