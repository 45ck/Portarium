...
- Port-family candidate ownership/blockers matrix: `docs/internal/research/port-family-integration-candidate-matrix.md`
- Index (generated): `docs/internal/research/index.md`

Commands:

- `npm run domain-atlas:vendor` clone missing upstreams and pin missing commits in source manifests
- `npm run domain-atlas:index` regenerate `docs/internal/research/index.md` from Domain Atlas sources
