...
See `.specify/specs/vaop-mvp-domain-atlas-research-programme.md` for the minimal MVP requirements and `docs/internal/adr/0035-domain-atlas-research-pipeline.md` for the rationale.
