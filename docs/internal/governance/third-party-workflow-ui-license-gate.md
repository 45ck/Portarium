...
- This checklist: `docs/internal/governance/third-party-workflow-ui-license-gate.md`
- Related platform audit (if applicable): `docs/internal/governance/external-execution-platform-license-audit.md`
- Strategy linkage (if applicable): `docs/internal/adr/0078-agentic-workflow-cockpit-reuse-vs-build-strategy.md`
