...
- STORY-I10.1 — bead-0401
  ...
  - AC: ADR created in `docs/internal/adr/`; licensing risks documented; multi-tenancy isolation requirements stated; decision rationale covers build-vs-buy trade-offs.
