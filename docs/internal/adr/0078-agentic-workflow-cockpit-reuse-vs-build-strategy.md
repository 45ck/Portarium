...
- ADR document: `docs/internal/adr/0078-agentic-workflow-cockpit-reuse-vs-build-strategy.md`
- Claimed bead record: `.beads/issues.jsonl` entry for `bead-0749`
- Licensing gate checklist: `docs/internal/governance/third-party-workflow-ui-license-gate.md`
