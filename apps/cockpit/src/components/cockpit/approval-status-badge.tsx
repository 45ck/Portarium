...
const config: Record<ApprovalStatus, { label: string; variant: 'default' | 'destructive' | 'outline'; className: string }> = {
  ...
  RequestChanges: { label: 'Request Changes', variant: 'outline',      className: 'border-orange-400 text-orange-600' },
}
