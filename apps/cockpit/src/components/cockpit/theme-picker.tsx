...
const themeInfo: Record<ThemeId, {
  ...
  'theme-arctic': {
    ...
    swatches: ['oklch(0.15 0.01 240)', 'oklch(0.6 0.12 220)', 'oklch(0.98 0.01 240)', 'oklch(0.9 0.02 240)'],
  },
  'theme-midnight': {
    name: 'Midnight',
    description: 'Dark, high-contrast',
    swatches: ['oklch(0.08 0.02 260)', 'oklch(0.5 0.15 260)', 'oklch(0.15 0.02 260)', 'oklch(0.9 0.02 260)'],
  },
  'theme-warm': {
    name: 'Warm',
    description: 'Warm amber tones',
    swatches: ['oklch(0.12 0.02 60)', 'oklch(0.65 0.15 60)', 'oklch(0.97 0.02 60)', 'oklch(0.88 0.03 60)'],
  },
  'theme-quantum': {
    name: 'Quantum',
    description: 'Vibrant purple accents',
    swatches: ['oklch(0.1 0.02 300)', 'oklch(0.55 0.2 300)', 'oklch(0.15 0.02 300)', 'oklch(0.88 0.02 300)'],
  },
}
