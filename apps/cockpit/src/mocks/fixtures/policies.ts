...
export const MOCK_POLICIES: PolicySummary[] = [
  {
    ...
    scope: 'actor, action',
    ruleCount: 2,
    affectedWorkflowIds: ['wf-invoice-remediation', 'wf-iam-review'],
    ruleText:
  ...
  },
  {
    ...
    ruleCount: 2,
    affectedWorkflowIds: ['wf-employee-onboarding'],
  ...
  },
  {
    ...
    ruleCount: 2,
    affectedWorkflowIds: ['wf-iam-review'],
  ...
  },
  {
    ...
    scope: 'robot safety',
    ruleCount: 2,
    affectedWorkflowIds: ['wf-robot-mission'],
...
export const MOCK_SOD_CONSTRAINTS: SodConstraint[] = [
  ...
  },
  {
    ...
    status: 'Active',
    rolePair: 'Finance Reviewer / Finance Requestor',
    forbiddenAction: 'Single-actor finance approval',
    scope: 'finance.change',
  ...
  },
  {
    ...
    status: 'Active',
    rolePair: 'IAM Reviewer / Finance Member',
  ...
  },
  {
    ...
    status: 'Active',
    rolePair: 'Safety Override / Mission Initiator',
    forbiddenAction: 'Self-override',
    scope: 'robotics.safety',
