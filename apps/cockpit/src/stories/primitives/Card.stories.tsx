        ...
        <Card key={label}>
          ...
          <CardContent>
            <div className="flex items-end gap-2">
              ...
              <span className={`text-xs font-medium flex items-center gap-0.5 mb-0.5 ${up ? 'text-success' : 'text-destructive'}`}>
    ...
    <div className="bg-background p-4 max-w-sm">
      <Card>
        <CardHeader>
          <div className="flex items-start justify-between">
            <div>
              ...
              <CardDescription className="text-xs mt-0.5">RUN-2041 · Started 14 min ago</CardDescription>
            </div>
        ...
        <CardContent className="space-y-3">
          ...
          <Button size="sm" className="w-full">Review &amp; Approve</Button>
        </CardContent>
      </Card>
    </div>
  ),
