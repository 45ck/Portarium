...
describe('canAccess role-gate matrix', () => {
  const cases: Array<{
    ...
    { persona: 'Admin', feature: 'approval-coverage:manage', expected: true },
    { persona: 'Operator', feature: 'approval-coverage:manage', expected: true },
    { persona: 'Approver', feature: 'approval-coverage:manage', expected: false },
    { persona: 'Auditor', feature: 'approval-coverage:manage', expected: false },
