...
import { Route as engineeringEvidenceWorkbenchRoute } from './routes/engineering/evidence-cards/workbench';
...
import { Route as configPoliciesStudioRoute } from './routes/config/policies-studio';
...
import { installedExternalRouteHostRoutes } from './routes/external/installed-extension-routes';
...
export const routeTree = rootRoute.addChildren([
  ...
  engineeringEvidenceWorkbenchRoute,
  searchRoute,
  workforceRoute,
  ...
  ...installedExternalRouteHostRoutes,
