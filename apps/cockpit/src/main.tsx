...
const RUNS = [
  {
    id: 'RUN-2041',
    title: 'Invoice remediation — ACME Repairs',
    status: 'Running',
    progress: 68,
    sla: '2h 14m',
  },
  {
    id: 'RUN-2040',
    title: 'New supplier onboarding — Bolt Ltd',
  ...
  {
    id: 'RUN-2038',
    title: 'Payment reconciliation — Mar',
    status: 'Failed',
    progress: 30,
    sla: 'overdue',
  },
  {
    id: 'RUN-2037',
    title: 'Contract renewal — TechSource',
    status: 'Paused',
    progress: 55,
    sla: '1d 6h',
  },
...
const DOMAIN_ICON_SHOWCASE: Array<{
  entityType: DomainEntityType;
  label: string;
}> = [
  { entityType: 'robot', label: 'Robot' },
  { entityType: 'drone', label: 'Drone' },
  { entityType: 'agent', label: 'Agent' },
  { entityType: 'adapter', label: 'Adapter' },
  { entityType: 'mission', label: 'Mission' },
  { entityType: 'evidence', label: 'Evidence' },
  { entityType: 'policy', label: 'Policy' },
  { entityType: 'fleet', label: 'Fleet' },
];

const ENTITY_IMAGE_SHOWCASE = [
  { id: 'robot-ground-alpha', label: 'Ground Robot Alpha', meta: 'Warehouse lane 3' },
  { id: 'robot-drone-gamma', label: 'Drone Gamma', meta: 'Inspection route 2' },
  { id: 'agent-ops-analyst', label: 'Ops Analyst Agent', meta: 'Assisted triage profile' },
  {
    id: 'agent-policy-reviewer',
    label: 'Policy Reviewer Agent',
    meta: 'Human-approve workflow support',
  },
];
        ...
        <main className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Alert variant="warning">
              ...
              <AlertDescription>
                RUN-2038 is overdue — payment reconciliation needs attention.
              </AlertDescription>
            </Alert>
            <Alert variant="success">
              ...
              <AlertDescription>
                All 48 evidence entries pass SHA-256 hash verification.
              </AlertDescription>
            </Alert>
          </div>
          ...
          <Tabs defaultValue="runs">
            <TabsList className="h-7">
              <TabsTrigger value="runs" className="text-xs h-5">
                Active runs
              </TabsTrigger>
              <TabsTrigger value="approval" className="text-xs h-5">
                Approval gate
              </TabsTrigger>
              <TabsTrigger value="tokens" className="text-xs h-5">
                Design tokens
              </TabsTrigger>
            </TabsList>
                ...
                <Card className="shadow-none">
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription className="text-xs">
                      New supplier onboarding — Bolt Ltd requires sign-off before proceeding.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    ...
                    <div className="space-y-1">
                      <Label className="text-xs">
                        Rationale <span className="text-muted-foreground">(min 20 chars)</span>
                      </Label>
                      <Textarea
                ...
                <Card className="shadow-none">
                  ...
                  <CardContent className="space-y-3">
                    <div className="space-y-1">
                      ...
                      <Select>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="alex" className="text-xs">
                            Alex Operator
                          </SelectItem>
                        </SelectContent>
                      </Select>
                    ...
                    <Alert variant="info">
                      ...
                      <AlertDescription>
                        Supplier spend &gt;$50k requires second approver per AP-07.
                      </AlertDescription>
                    </Alert>
                  </CardContent>
                </Card>
            ...
            <TabsContent value="tokens">
              <div className="space-y-4">
                ...
                <Card className="shadow-none">
                  ...
                  <CardContent className="space-y-2">
                    ...
                    <div className="text-sm">
                      Body 14 / regular — default cockpit text, table cells
                    </div>
                    <div className="text-xs text-muted-foreground">
                      Caption 12 / muted — metadata, timestamps, labels
                    </div>
                    <div className="font-mono text-xs text-muted-foreground">
                      Mono 12 — RUN-2041 · corr:8f3a2b · 2026-02-20T00:00:00Z
                    </div>
                    <Separator />
                ...
                <Card className="shadow-none">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm">Domain Assets (Manifest-backed)</CardTitle>
                    <CardDescription className="text-xs">
                      Domain entities use generated icons/images. Generic UI controls remain Lucide.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      <p className="text-[11px] font-medium text-muted-foreground uppercase tracking-wide">
                        Isometric domain icons
                      </p>
                      <div className="grid grid-cols-4 gap-3">
                        {DOMAIN_ICON_SHOWCASE.map((item) => (
                          <div
                            key={item.entityType}
                            className="border-border bg-muted/20 flex items-center gap-2 rounded-md border p-2"
                          >
                            <EntityIcon entityType={item.entityType} size="md" />
          ...
          <div className="flex h-full divide-x divide-gray-300">
            {THEMES.map((t) => (
              <div key={t.id} className={`flex-1 min-w-0 overflow-hidden ${t.id}`}>
                ...
                <div
                  className="h-[calc(100%-24px)] overflow-hidden"
                  style={{
                    transform: 'scale(0.6)',
