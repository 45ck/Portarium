# micro-saas-toolchain-redo toolchain-realism-v2
...
| --- | --- | --- | --- |
| content-machine | true | failed | content-machine CLI is required for this experiment but is not installed or not on PATH. |
...
| --- | --- | --- | --- | --- |
| content-machine | preflight-and-content-draft | failed | toolchain-preflight.json | none |
