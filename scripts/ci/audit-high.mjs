 ...
 *
 * Scope: production dependencies only (--omit=dev).  Dev-only tools
 * such as eslint carry transitive ajv v6 advisories (GHSA-2g4f-4pwh-qvx6)
 * that are not exploitable in this project's runtime context; they are
 * tracked separately in bead-0339 pending an eslint upstream fix.
 */
