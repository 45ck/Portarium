/**
 * Outbox dispatch ordering integration tests.
 *
 * Verifies that events are delivered in enqueue (entryId) order, including
...
// ---------------------------------------------------------------------------
// Minimal fixtures needed for outbox-only tests
// ---------------------------------------------------------------------------
