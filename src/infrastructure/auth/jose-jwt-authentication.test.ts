/**
 * Core authentication tests for JoseJwtAuthentication (missing header, invalid sig,
 * expiry, claim extraction, workspace scope, and Keycloak claim formats).
 *
 * Advanced config tests (typ, azp, trustedIssuers) are in
 * jose-jwt-authentication-advanced.test.ts to stay within max-lines-per-function.
 */
...
describe('JoseJwtAuthentication', () => {
  ...
  // (Advanced config tests — typ, azp, trustedIssuers — are in
  //  jose-jwt-authentication-advanced.test.ts)
