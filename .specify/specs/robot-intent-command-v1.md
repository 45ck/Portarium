...
An `IntentCommandV1` describes _what_ a robot should do, not _how_. The local robot system is responsible for translating the intent into low-level motion commands.
