...
| --- | -------------------------------- | -------------------------------------------------------------------------------- |
| 1   | Projection lag SLA documented    | `docs/internal/governance/retrieval-release-readiness.md` contains lag SLA table |
...
| Release readiness doc       | `docs/internal/governance/retrieval-release-readiness.md`                |
