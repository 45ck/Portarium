...
| `command` | `registerMachine`         | `workspace:register` | `src/application/commands/machine-agent-registration.ts` | `RegisterMachineInput`         | `RegisterMachineOutput`         | `MachineAgentRegistrationError` |
| `command` | `createAgent`             | `workspace:register` | `src/application/commands/machine-agent-registration.ts` | `CreateAgentInput`             | `CreateAgentOutput`             | `MachineAgentRegistrationError` |
| `command` | `updateAgentCapabilities` | `workspace:register` | `src/application/commands/machine-agent-registration.ts` | `UpdateAgentCapabilitiesInput` | `UpdateAgentCapabilitiesOutput` | `MachineAgentRegistrationError` |
