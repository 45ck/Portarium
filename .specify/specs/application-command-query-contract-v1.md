...
| `command` | `cancelRun`                      | `run:intervene`             | `src/application/commands/cancel-run.ts`                         | `CancelRunInput`                      | `CancelRunOutput`                      | `CancelRunError`                      |
...
| `command` | `proposePolicyChange`            | `policy-change:propose`     | `src/application/commands/policy-change-workflow.ts`             | `ProposePolicyChangeInput`            | `PolicyChangeOutput`                   | `PolicyChangeCommandError`            |
| `command` | `approvePolicyChange`            | `policy-change:approve`     | `src/application/commands/policy-change-workflow.ts`             | `ApprovePolicyChangeInput`            | `PolicyChangeOutput`                   | `PolicyChangeCommandError`            |
| `command` | `rollbackPolicyChange`           | `policy-change:rollback`    | `src/application/commands/policy-change-workflow.ts`             | `RollbackPolicyChangeInput`           | `PolicyChangeOutput`                   | `PolicyChangeCommandError`            |
| `command` | `recordPolicyChangeReplayReport` | `policy-change:replay`      | `src/application/commands/record-policy-change-replay-report.ts` | `RecordPolicyChangeReplayReportInput` | `RecordPolicyChangeReplayReportOutput` | `RecordPolicyChangeReplayReportError` |
...
| `query`   | `getPlan`                        | `plan:read`                 | `src/application/queries/get-plan.ts`                            | `GetPlanInput`                        | `GetPlanOutput`                        | `GetPlanError`                        |
| `query`   | `listEvidenceEntries`            | `evidence:read`             | `src/application/queries/list-evidence-entries.ts`               | `ListEvidenceEntriesInput`            | `ListEvidenceEntriesOutput`            | `ListEvidenceEntriesError`            |
| `query`   | `listRunEvidence`                | `evidence:read`             | `src/application/queries/list-run-evidence.ts`                   | `ListRunEvidenceInput`                | `ListRunEvidenceOutput`                | `ListRunEvidenceError`                |
| `query`   | `previewPolicyChangeReplay`      | `policy-change:replay`      | `src/application/queries/preview-policy-change-replay.ts`        | `PreviewPolicyChangeReplayInput`      | `PreviewPolicyChangeReplayOutput`      | `PreviewPolicyChangeReplayError`      |
...
| `command` | `syncAgentToGateway`             | `machine-agent:bridge-sync` | `src/application/commands/sync-agent-to-gateway.ts`              | `SyncAgentToGatewayInput`             | `SyncAgentToGatewayOutput`             | `SyncAgentToGatewayError`             |
| `command` | `deactivateMachine`              | `machine-agent:bridge-sync` | `src/application/commands/deactivate-machine.ts`                 | `DeactivateMachineInput`              | `DeactivateMachineOutput`              | `DeactivateMachineError`              |
...
| policy shadow replay query and evidence report command                                               | `bead-1068`          |
